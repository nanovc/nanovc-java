 ...
 */
public abstract class EncodedStringAreaAPITestsBase<TMapArea extends EncodedStringAreaAPI & Map<String, EncodedStringContent>>
    extends EncodedStringMapAreaTestsBase<TMapArea>
{
    /**
