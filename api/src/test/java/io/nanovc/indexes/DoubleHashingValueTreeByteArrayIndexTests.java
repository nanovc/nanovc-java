...
/**
 * Tests for the {@link DoubleHashingValueTreeByteArrayIndex}.
 */
public class DoubleHashingValueTreeByteArrayIndexTests extends ByteArrayIndexTestBase<DoubleHashingValueTreeByteArrayIndex>
{
    /**
     ...
     */
    @Override
    protected DoubleHashingValueTreeByteArrayIndex createNewByteArrayIndex()
    {
        return new DoubleHashingValueTreeByteArrayIndex();
    }
    ...
    {
        // Create the index:
        DoubleHashingValueTreeByteArrayIndex index = createNewByteArrayIndex();
