 ...
 * then use {@link StringHashMapArea} instead.
 * It is backed by a {@link EncodedStringHashMapArea} which is efficient for access but does not preserve order of its contents.
 * The key is the absolute repo path for the content.
 * The value is the {@link EncodedStringContent}.
 */
public class EncodedStringHashMapArea
    extends HashMapArea<EncodedStringContent>
    implements EncodedStringAreaAPI
{
     ...
     */
    public static EncodedStringHashMapArea fromStringArea(StringAreaAPI stringArea)
    {
        EncodedStringHashMapArea area = new EncodedStringHashMapArea();
