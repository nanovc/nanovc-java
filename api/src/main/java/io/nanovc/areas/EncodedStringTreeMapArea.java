 ...
 * then use {@link StringTreeMapArea} instead.
 ...
 */
public class EncodedStringTreeMapArea
    ...
    implements EncodedStringAreaAPI
{
     ...
     */
    public EncodedStringTreeMapArea(Charset charset)
    {
     ...
     * however, this is the default character set to use for encoding new content.
     */
    public EncodedStringTreeMapArea()
    {
     ...
     */
    public static EncodedStringTreeMapArea fromStringArea(StringAreaAPI stringArea)
    {
        EncodedStringTreeMapArea area = new EncodedStringTreeMapArea();
